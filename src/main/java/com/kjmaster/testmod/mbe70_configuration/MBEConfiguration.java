...
public class MBEConfiguration {
    ...
    public static int myInteger = MBEGuiHandler.testMod.categoryGeneral.myInteger;
    public static boolean myBoolean = MBEGuiHandler.testMod.categoryGeneral.myBoolean;
    public static double myDouble = MBEGuiHandler.testMod.categoryGeneral.myDouble;
    public static int[] myIntList = MBEGuiHandler.testMod.categoryGeneral.myIntList;
    public static String myString = MBEGuiHandler.testMod.categoryGeneral.myString;
    ...
    private static void syncConfig(boolean loadConfigFromFile, boolean readFieldsFromConfig) {
        ...
        propColour.setLanguageKey("gui.mbe70_configuration.myColour");
        ...
        propOrderGeneral.add(propMyInt.getName());
    ...
    public static class ConfigEventHandler
    {
        ...
        {
            if (TestMod.MODID.equals(event.getModID()) && !event.isWorldRunning())
            {
