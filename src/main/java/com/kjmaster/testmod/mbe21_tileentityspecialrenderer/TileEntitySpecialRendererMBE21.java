...
import com.kjmaster.testmod.usefultools.UsefulFunctions;
...
public class TileEntitySpecialRendererMBE21 extends TileEntitySpecialRenderer<TileEntityMBE21> {
     ...
     * @param te the associated tile entity
     ...
     */
    @Override
    public void render(TileEntityMBE21 te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        // the appearance and animation of the gem is hence made up of four parts:
        ...
        Vec3d pedestalCentre = new Vec3d(x + pedestalCentreOffsetX, y + pedestalCentreOffsetY, z + pedestalCentreOffsetZ);
        ...
        double gemCentreOffsetY = pedestalCentreOffsetY + UsefulFunctions.interpolate(playerDistance, DISTANCE_FOR_MIN_LEVITATE,
        ...
        double angularPositionInDegrees = te.getNextAngularPosition(revsPerSecond);
        ...
        try {
            ...
            Color fullBrightnessColour = te.getGemColour();
            float red = 0, green = 0, blue = 0;
            if (fullBrightnessColour != te.INVALID_COLOUR) {
                red = (float) (fullBrightnessColour.getRed() / 255.0);
                green = (float) (fullBrightnessColour.getGreen() / 255.0);
                blue = (float) (fullBrightnessColour.getBlue() / 255.0);
            }
            ...
            OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, SKY_LIGHT_VALUE * 16.0F,
                    BLOCK_LIGHT_VALUE * 16.0F);
    ...
    // this should be true for tile entities which render globally (no render bounding box), such as beacons.
    @Override
    public boolean isGlobalRenderer(TileEntityMBE21 te) {
        return false;
    }
    ...
    private static final ResourceLocation gemTexture =
            new ResourceLocation("testmod:textures/entity/mbe21_tesr_gem.png");
}
